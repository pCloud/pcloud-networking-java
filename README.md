...
```groovy
compile 'pcloud-networking-java:composer:1.0.4'
```
...
```groovy
compile 'pcloud-networking-java:binapi-client:1.0.4'
```
...
```groovy
compile 'pcloud-networking-java:serialization:1.0.4'
```
--------------------------------------------------------------------------------
### Protocol
...
```groovy
compile 'pcloud-networking-java:protocol:1.0.4'
```
