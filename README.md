...
```groovy
compile 'pcloud-networking-java:composer:1.2.0'
```
...
```groovy
compile 'pcloud-networking-java:binapi-client:1.2.0'
```
...
```groovy
compile 'pcloud-networking-java:serialization:1.2.0'
```
--------------------------------------------------------------------------------
### Protocol
...
```groovy
compile 'pcloud-networking-java:protocol:1.2.0'
```
