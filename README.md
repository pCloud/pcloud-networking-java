...
```groovy
compile 'com.pcloud.pcloud-networking-java:composer:2.1.0'
```
...
```groovy
compile 'com.pcloud.pcloud-networking-java:binapi-client:2.1.0'
```
...
```groovy
compile 'com.pcloud.pcloud-networking-java:serialization:2.1.0'
```
--------------------------------------------------------------------------------
### Protocol
...
```groovy
compile 'com.pcloud.pcloud-networking-java:protocol:2.1.0'
```
