...
```groovy
compile 'com.pcloud.pcloud-networking-java:composer:2.2.0'
```
...
```groovy
compile 'com.pcloud.pcloud-networking-java:binapi-client:2.2.0'
```
...
```groovy
compile 'com.pcloud.pcloud-networking-java:serialization:2.2.0'
```
--------------------------------------------------------------------------------
### Protocol
...
```groovy
compile 'com.pcloud.pcloud-networking-java:protocol:2.2.0'
```
